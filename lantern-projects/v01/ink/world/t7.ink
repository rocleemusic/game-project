...
* {present_toby == "T7" && day >= 5 && TimeOfDay != morning} [Talk to Toby] #scene:SC-T7-toby -> toby.sc_t7_toby
* {present_ilsa == "T7" && day >= 5 && TimeOfDay != morning} [Talk to Ilsa] #scene:SC-T7-ilsa -> ilsa.sc_t7_ilsa
+ [Look at stage] -> stage
